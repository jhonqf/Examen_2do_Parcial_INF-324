<div class="card text-center">
  ...
  <div>
    <img src="img/solicitud.png" style="width: 14rem; height:10rem;" class="mt-5 center-block" alt="...">
  </div>
  ...
  <div class="card-body">
    ...
    <h5 class="card-title">Atencion de solicitud de emision de certificado</h5>
